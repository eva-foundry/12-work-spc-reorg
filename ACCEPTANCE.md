# 12-work-spc-reorg -- Acceptance Criteria
...
**Criteria**: `GET /model/projects/12-work-spc-reorg` returns maturity, phase, pbi_total >= 1.
**Verification**:
```powershell
Invoke-RestMethod "http://localhost:8010/model/projects/12-work-spc-reorg" |
...
**Verification**: Run MCP tool `audit_project` with target_path = C:\eva-foundry\12-work-spc-reorg
**Status**: PENDING
...
**Verification**: Run MCP tool `get_trust_score` with repo_path = C:\eva-foundry\12-work-spc-reorg
**Status**: PENDING
...
**Verification**: Run MCP tool `check_encoding` with target_path = C:\eva-foundry\12-work-spc-reorg
**Status**: PENDING
