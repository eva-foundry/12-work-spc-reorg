...
<!-- Placeholders: 12-work-spc-reorg = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 12-work-spc-reorg - Organization Standards
