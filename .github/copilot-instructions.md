# GitHub Copilot Instructions -- Workspace Reorg

**Template Version**: 3.0.0
**Last Updated**: February 23, 2026
**Project**: Workspace Reorg -- Planning project to restructure the VS Code workspace for shorter paths, clearer project separation, and cross-platform script compatibility.
**Path**: `C:\AICOE\eva-foundry\12-work-spc-reorg\`
...
4. **Query the data model** for this project's record:
   `powershell
   Invoke-RestMethod "http://localhost:8010/model/projects/12-work-spc-reorg" | Select-Object id, maturity, notes
   `
...
This file is the copilot-instructions for **12-work-spc-reorg** (Workspace Reorg).
...
Once this file has been loaded, the active project is locked to **12-work-spc-reorg** for the entire session.
...
**Folder**: `C:\AICOE\eva-foundry\12-work-spc-reorg`
**ADO Epic**: [TODO]
...
Invoke-RestMethod "http://localhost:8010/model/endpoints/" |
  Where-Object { $_.implemented_in -like '*12-work-spc-reorg*' } |
